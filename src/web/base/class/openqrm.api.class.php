 ...
 * Openqrm Content
 *
    openQRM Community developed by openQRM Enterprise GmbH.
...
var $rootdir;
	...
	function get_info_box() {
		...
		echo "openQRM Community developed by openQRM Enterprise GmbH.<br>
			All source code and content (c) Copyright 2014, openQRM Enterprise GmbH unless specifically noted otherwise. This source code is released under the GNU General Public License version 2	unless otherwise agreed with openQRM Enterprise GmbH.
			The latest version of this license can be found at <a href='src/doc/LICENSE.txt' TARGET='_BLANK'>src/doc/LICENSE.txt</a>. By using this software, you acknowledge having read this license and agree to be bound thereby.<br>";
		echo "</p>";
	}
