...
<div class="top">
	<form>
		...
		<a id="Support_box" href="http://www.openqrm-enterprise.com?s=oqbe" target="_blank">{support}</a>
		<a id="Docu_box" href="http://www.openqrm.com/resources?s=oqbe" target="_blank">{documentation}</a>
