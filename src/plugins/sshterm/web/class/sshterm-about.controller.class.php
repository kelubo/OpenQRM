...
class sshterm_about_controller
{
/**
...
* @var string
*/
var $actions_name = 'sshterm_about_action';
/**
* message param
* @access public
* @var string
*/
var $message_param = 'sshterm_about_msg';
/**
* id for tabs
* @access public
* @var string
*/
var $prefix_tab = 'sshterm_about_tab';
/**
* identifier name
* @access public
* @var string
*/
var $identifier_name = 'sshterm_about_identifier';
/**
* path to templates
* @access public
* @var string
...
var $lang = array(
	...
	function __construct($openqrm, $response) {
		...
		$this->lang     = $this->user->translate($this->lang, $this->rootdir."/plugins/sshterm/lang", 'sshterm-about.ini');
	...
	function documentation( $hidden = true ) {
		$data = '';
		if( $hidden === true ) {
			require_once($this->rootdir.'/plugins/sshterm/class/sshterm-about.documentation.class.php');
			$controller = new sshterm_about_documentation($this->openqrm, $this->response);
	...
	function bootservice( $hidden = true ) {
		$data = '';
		if( $hidden === true ) {
			require_once($this->rootdir.'/plugins/sshterm/class/sshterm-about.bootservice.class.php');
			$controller = new sshterm_about_bootservice($this->openqrm, $this->response);
			$controller->actions_name    = $this->actions_name;
			$controller->tpldir          = $this->tpldir;
			$controller->message_param   = $this->message_param;
	...
	function vms( $hidden = true ) {
		$data = '';
		if( $hidden === true ) {
			require_once($this->rootdir.'/plugins/sshterm/class/sshterm-about.vms.class.php');
			$controller = new sshterm_about_vms($this->openqrm, $this->response);
			$controller->actions_name    = $this->actions_name;
			$controller->tpldir          = $this->tpldir;
			$controller->message_param   = $this->message_param;
	...
	function usage( $hidden = true ) {
		$data = '';
		if( $hidden === true ) {
			require_once($this->rootdir.'/plugins/sshterm/class/sshterm-about.usage.class.php');
			$controller = new sshterm_about_usage($this->openqrm, $this->response);
			$controller->actions_name    = $this->actions_name;
			$controller->tpldir          = $this->tpldir;
			$controller->message_param   = $this->message_param;
