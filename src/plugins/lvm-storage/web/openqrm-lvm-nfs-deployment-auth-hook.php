...
*/
	...
	*/
	...
	function storage_auth_stop($image_id) {
		...
		$auth_stop_cmd = $OPENQRM_SERVER_BASE_DIR."/openqrm/plugins/".$deployment_plugin_name."/bin/openqrm-".$deployment_plugin_name." auth -r ".$image_rootdevice." -i ".$OPENQRM_SERVER_IP_ADDRESS." -t lvm-nfs-deployment --openqrm-cmd-mode background";
		$resource = new resource();
