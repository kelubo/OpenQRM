...
function remove_iscsi_deployment($cloud_image_id) {
	...
	$image_location=dirname($image_rootdevice);
	$image_location_name=basename($image_location);
	$image_remove_clone_cmd=$OPENQRM_SERVER_BASE_DIR."/openqrm/plugins/iscsi-storage/bin/openqrm-iscsi-storage remove -n ".$image_location_name." --openqrm-cmd-mode background";
